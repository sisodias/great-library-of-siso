...
Agents is the first Section of The Great Library of SISO. The initial seed is intentionally small and evidence-led; inclusion describes a Work and does not guarantee source payload availability, installation, support, portability, or Library-level redistribution.

## Verified repository locators

The integration lane verified the following public repository metadata for V1 on 2026-07-29. These are replaceable locators and repository-level license observations, not stable Work IDs or Release receipts.
...
Every accepted seed Work still receives a stable Library detail URL. An upstream documentation or demo URL may be added when it is public and evidenced, but is optional.
