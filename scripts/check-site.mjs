...
if (intelligence.counts?.events !== 29 || intelligence.counts?.active_initiatives !== 1) errors.push("intelligence.json: expected 29 Events and one active People Graph initiative at V37 program launch");
