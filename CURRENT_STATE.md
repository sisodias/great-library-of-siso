...
- Ecosystem Intelligence is generated at `/intelligence/` and `/intelligence.json` from four immutable ADRs, eleven append-only Events, and the automatic history of all 57 Releases and 27 Snapshots. The current projection has zero active initiatives; live lanes must publish branch and machine-neutral path reservations before parallel work begins.
- Whole Library V27 — 100 Million Token Program (`gls:snapshot:a49a727d-8b8b-4aea-83b1-ad7f137fff11`) is the active Snapshot.
...
- The Library's selected self-release is `0.7.0+1e7453e`, pinned to `1e7453e76d339f4d9cae5a63ca6913467775a233`.
